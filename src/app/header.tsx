...
export default function Header() {
  ...
  return (
    <header className="w-full flex items-center justify-between px-8 py-4 border-b border-gray-200 font-sans bg-gray-50">
      <Link href="/" className="text-2xl font-bold text-gray-900">kyo1941</Link>
      <nav>
        <ul className="flex gap-8 text-gray-900 text-base font-medium">
          {navItems.map(item => (
            <li key={item.id}>
