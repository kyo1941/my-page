    ...
    <div>
      ...
      <div className="prose max-w-none prose-lg">
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
            Androidネイティブアプリ開発を主にやっています。最近はKotlin Multi Platformに興味を持っていたり。<br />
            クライアント側だけでなく、バックエンドにも興味を持っており勉強しています。大学のうちにバックエンドも実務経験ちょっとでもできたらな〜と思っています。<br />
            また、競技プログラミングにも取り組んでおりAtCoderに参加しています。弱々ですが楽しんでおります。大学のうちに水色いきたいな〜。<br />
            <br />
