...
export const careerData: Career[] = [
  {
    ...
    tasks: [
      ...
      { text: "古いライブラリの更新に伴い、ADRの作成とPoCの実装による技術調査と選定を行った。" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { text: "ショート動画実装の大規模案件のメンバーとしてアサインされ、画面の実装とAPI連携を担当。" },
    ],
