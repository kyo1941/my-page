        ...
        {blogs.length === 0 ? (
          ...
          blogs.map((blog) => (
            <Link
              ...
              className="block"
            >
              <div className="bg-gray-50 p-6 rounded-lg shadow-lg flex flex-col h-full transition-all duration-300 min-h-52 md:min-h-0 hover:-translate-y-1 hover:shadow-xl">
